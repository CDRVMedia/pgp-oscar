...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.game'
        db.add_column('catalogue_category', 'game',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['game.Game']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.game'
        db.delete_column('catalogue_category', 'game_id')
