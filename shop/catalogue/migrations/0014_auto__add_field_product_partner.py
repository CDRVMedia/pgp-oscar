...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.partner'
        db.add_column('catalogue_product', 'partner',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=148, to=orm['partner.Partner']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.partner'
        db.delete_column('catalogue_product', 'partner_id')
