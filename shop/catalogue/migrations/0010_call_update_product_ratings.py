...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        pass
        # commented this out because it failed since the pgp version of Product has new fields that haven't been added yet.
        #  this migration should not be necessary since there are no products that pre-dated the new ratings in PGP
