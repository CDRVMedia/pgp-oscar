...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Category', fields ['game', 'slug']
        db.create_unique('catalogue_category', ['game_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Category', fields ['game', 'slug']
        db.delete_unique('catalogue_category', ['game_id', 'slug'])
