...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('catalogue_product', 'price_currency',
                      self.gf('django.db.models.fields.CharField')(default='USD', max_length=12),
                      keep_default=False)

        # Adding field 'Product.price_excl_tax'
        db.add_column('catalogue_product', 'price_excl_tax',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('catalogue_product', 'price_currency')

        # Deleting field 'Product.price_excl_tax'
        db.delete_column('catalogue_product', 'price_excl_tax')
    ...
    models = {
        ...
        'catalogue.product': {
            ...
            'price_excl_tax': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '2'}),
