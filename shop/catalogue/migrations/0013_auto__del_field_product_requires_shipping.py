...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product.requires_shipping'
        db.delete_column('catalogue_product', 'requires_shipping')


    def backwards(self, orm):
        # Adding field 'Product.requires_shipping'
        db.add_column('catalogue_product', 'requires_shipping',
