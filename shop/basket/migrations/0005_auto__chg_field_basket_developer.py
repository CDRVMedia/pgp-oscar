...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Basket.developer'
        db.alter_column('basket_basket', 'developer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['developer.Developer'], null=True))

    def backwards(self, orm):

        # Changing field 'Basket.developer'
        db.alter_column('basket_basket', 'developer_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['developer.Developer']))
    ...
    models = {
        ...
        'basket.basket': {
            ...
            'developer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['developer.Developer']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
