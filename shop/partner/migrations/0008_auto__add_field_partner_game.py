...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Partner.game'
        db.add_column('partner_partner', 'game',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, related_name='partner', unique=True, to=orm['game.Game']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Partner.game'
        db.delete_column('partner_partner', 'game_id')
