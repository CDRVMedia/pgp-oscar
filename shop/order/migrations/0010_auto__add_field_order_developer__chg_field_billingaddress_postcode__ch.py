...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.developer'
        db.add_column('order_order', 'developer',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['developer.Developer'], null=True, on_delete=models.SET_NULL, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        # Deleting field 'Order.developer'
        db.delete_column('order_order', 'developer_id')


        # Changing field 'BillingAddress.postcode'
        db.alter_column('order_billingaddress', 'postcode', self.gf('django.db.models.fields.CharField')(default=0, max_length=64))

        # Changing field 'ShippingAddress.postcode'
        db.alter_column('order_shippingaddress', 'postcode', self.gf('django.db.models.fields.CharField')(default=0, max_length=64))
    ...
    models = {
        ...
        'order.order': {
            ...
            'developer': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['developer.Developer']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
